...
//    private TextView tvThree;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_pager_four);
        initViews();
    }
    ...
    private void initViews() {
        ...
        vpFour.setAdapter(new PagerListAdapter(_views));
        vpFour.setCurrentItem(0);          //设置ViewPager当前页，从0开始算

        vpFour.addOnPageChangeListener(this);
    }

    @Override
    public void onClick(View v) {

        vpFour.setCurrentItem((int)v.getTag());
    }
    ...
    public void onPageSelected(int index) {
        ...
        ivCursor.startAnimation(animation);//开始动画
    }
