...
public class ViewPagerThreeActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        com.water.uisample.databinding.ActivityViewPagerThreeBinding binding = DataBindingUtil.setContentView(this, R.layout.activity_view_pager_three);
        ...
        binding.vpThree.setAdapter(_adapter);
    }
}
